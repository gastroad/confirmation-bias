              ...
              <span>
                ...
                {s.articleCount === 0 ? (
                  ...
                  <span className={styles.rowMeta}>
                    기사 <span className={styles.rowNum}>{s.articleCount.toLocaleString()}</span>건
                    · 이슈 <span className={styles.rowNum}>{s.clusterCount.toLocaleString()}</span>
                    개 · 단독{" "}
