    ...
    <AppShell prose>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          ...
          짧은 발췌(최대 300자), 언론사명, 원문 링크만 표시하며 전문을 복제하거나 저장하지 않습니다.
        </p>
        <p className={styles.paragraph}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          서비스는 개인이 운영하는 비상업적 프로젝트로, 기능이 예고 없이 변경되거나 서비스가 중단될
          수 있습니다. 이 경우 이용자에게 별도의 보상을 하지 않습니다.
        </p>
        <p className={styles.paragraph}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          서비스는 표시되는 정보의 정확성·완전성·최신성을 보증하지 않습니다. 기사 묶음이 기계적으로
          생성되는 만큼 오분류가 발생할 수 있으며, 이를 근거로 한 이용자의 판단과 그 결과에 대해
          서비스는 책임지지 않습니다.
        </p>
        <p className={styles.paragraph}>
