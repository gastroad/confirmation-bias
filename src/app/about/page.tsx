  ...
  return (
    <AppShell prose>
      ...
      <p className={styles.lead}>
        ...
        보도하는지를 숫자로 보여주는 서비스입니다. 기사를 쓰지 않고, 이미 나온 기사들이 어떤 분포를
        이루는지만 계산합니다. 이 페이지는 <strong>그 계산이 어떻게 이뤄지는지</strong>와{" "}
        ...
        <div className={styles.steps}>
          ...
          <div className={styles.step}>
            ...
            <span className={styles.stepBody}>
              ...
              <span className={styles.mono}>{THRESHOLD}</span> 입니다. 더 낮추면 서로 다른 사건이 한
              덩어리가 되고, 더 높이면 하나여야 할 대형 이슈가 둘로 쪼개집니다. 세 날짜를 0.54~0.70
              구간에서 실측해 고른 값입니다.
            </span>
          </div>
          <div className={styles.step}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          ...
          인식과 각 매체의 사설·논조 경향을 바탕으로 서로의 <em>상대적</em> 자리를 정한 것이며, 특정
          연구의 측정치를 그대로 옮긴 것이 아닙니다. 출처를 밝힐 수 있는 정량 지표가 아니므로{" "}
      ...
      <section className={styles.section}>
        ...
        <p className={styles.paragraph}>
          ...
          {TILT_BALANCE_THRESHOLD}%p 이내면 &ldquo;균형&rdquo;으로 봅니다. 이 기준은 디자인이 아니라
          서비스의 주장이므로 목록 화면에도 그대로 적어 둡니다.
        </p>
        <p className={styles.paragraph}>
          검색엔진에 노출되는 사건은{" "}
          <strong>
      ...
      <section className={styles.section}>
        ...
        <ul className={styles.list}>
          ...
          <li>
            ...
            곳이 보도했나&rdquo;는 그 진영의 매체 수에 영향을 받습니다. 비율을 함께 보시기 바랍니다.
          </li>
          <li>
